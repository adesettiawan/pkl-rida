                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Data Laporan KKN</h4>
                            <div class="card-header-action">
                                <a href="<?= base_url('admin/laporan_kkn/exportPDF') ?>" target="_blank" class="btn btn-danger px-2 btn-sm text-white mr-2"><i class="fas fa-download"></i> &nbsp; Rekap Data</a>
                                <?php if ($userLogin == 1) : ?>
                                    <a href="<?= base_url('admin/laporan_kkn/add') ?>" class="btn btn-primary"><i class="fas fa-plus"></i>&ensp;Tambah Data</a>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <?php if ($userLogin == 1) : ?>
                                                                ...
                                                                <a href="<?= base_url('admin/laporan_kkn/edit/' . $rpt['id']) ?>" class="dropdown-item has-icon"><i class="far fa-edit"></i> Edit</a>

                                                                <div class="dropdown-divider"></div>
                                                                <a href="<?= base_url('admin/laporan_kkn/delete/' . $rpt['id']) ?>" class="dropdown-item has-icon text-danger"><i class="far fa-trash-alt"></i>
                                                                    Delete</a>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
        ...
        <div class="modal fade" id="staticBackdrop<?= $rpt['id'] ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('admin/laporan_kkn/verifikasiStatus/' . $rpt['id']) ?>" method="POST">
