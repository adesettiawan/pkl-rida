                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Laporan PKL</h4>
                            <div class="card-header-action">
                                <a href="<?= base_url('admin/laporan_pkl') ?>" class="btn btn-dark"><i class="fas fa-angle-left"></i>&ensp;Back</a>
                            </div>
                        </div>
                        <?php
                        ...
                        <form action="<?= base_url('admin/laporan_pkl/update/' . $laporan['id']) ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <?= csrf_field() ?>
