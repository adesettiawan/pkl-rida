                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Laporan Penelitian</h4>
                            <div class="card-header-action">
                                <a href="<?= base_url('admin/laporan_penelitian') ?>" class="btn btn-dark"><i class="fas fa-angle-left"></i>&ensp;Back</a>
                            </div>
                        </div>
                        <?php
                        ...
                        <form action="<?= base_url('admin/laporan_penelitian/update/' . $laporan['id']) ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <?= csrf_field() ?>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="user_id" id="user_id" class="form-control select2">
                                            ...
                                            <?php foreach ($users as $key => $user) { ?>
                                                <option value="<?= $user['id'] ?>" <?= $user['id'] == $laporan['user_id'] ? 'selected' : '' ?>><?= $user['name'] ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="filename" type="text" class="form-control" value="<?= $laporan['filename'] ?>" name="filename" required>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-3">
                                            ...
                                            <span class="text-info">Nama file: <?= $laporan['file_reports'] ?></span>
                                        </div>
                                        <div class="col-9">
                                            <label for="file_reports">Upload File Laporan </label>
                                            <input class="form-control mb-2" type="file" name="file_reports" value="<?= $laporan['file_reports'] ?>" id="file_reports" accept="application/pdf" onChange="validate2(this.value)" />
