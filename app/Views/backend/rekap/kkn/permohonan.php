                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Rekap Data Surat Permohonan KKN</h4>
                        </div>
                        <style type="text/css">
                                ...
                                <table border="1">
                                    ...
                                    <?php foreach ($data_permohonan as $permohonan) : ?>
                                        <tr>
                                            ...
                                            <td><a href="<?= base_url('assets/file_surat/kkn/' . $permohonan['file_surat']) ?>" target="_blank" class="btn btn-danger px-2 btn-sm text-white">Link Surat</td>
                                            <td>
