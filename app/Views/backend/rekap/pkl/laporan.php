                                ...
                                <table border="1">
                                    ...
                                    <?php foreach ($data_laporan as $rpt) : ?>
                                        <tr>
                                            ...
                                            <td><?= $rpt['filename'] ?></td>
                                            <td><a href="<?= base_url('assets/file_reports/pkl/' . $rpt['file_reports']) ?>" target="_blank" class="btn btn-danger px-2 btn-sm text-white">Link File</a></td>
                                            <td>
                                                <?php if ($rpt['status'] == 1) { ?>
