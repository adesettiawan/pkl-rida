                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Rekap Data Surat Balasan PKL</h4>
                        </div>
                        <style type="text/css">
                                ...
                                <table border="1">
                                    ...
                                    <?php foreach ($data_balasan as $balasan) : ?>
                                        <tr>
                                            ...
                                            <td><a href="<?= base_url('assets/file_replies/pkl/' . $balasan['file_replies']) ?>" target="_blank" class="btn btn-danger px-2 btn-sm text-white">Link File</a></td>
                                            <td>
