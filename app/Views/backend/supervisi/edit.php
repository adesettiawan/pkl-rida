            ...
            <div class="row">
                <div class="col-8">
                    <div class="card">
                        ...
                        <form action="<?= base_url('admin/supervisi/update/' . $supervisi['id']) ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <?= csrf_field() ?>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="user_id" id="user_id" class="form-control select2">
                                            ...
                                            <?php foreach ($users as $key => $user) { ?>
                                                <option value="<?= $user['id'] ?>" <?= $user['id'] == $supervisi['user_id'] ? 'selected' : '' ?>><?= $user['name'] ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
