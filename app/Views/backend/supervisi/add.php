                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-header">
                            <h4>Tambah Pengajuan Supervisi</h4>
                            <div class="card-header-action">
                                <a href="<?= base_url('admin/supervisi') ?>" class="btn btn-dark"><i class="fas fa-angle-left"></i>&ensp;Back</a>
                            </div>
                        </div>
                        <?php
                        ...
                        <form action="<?= base_url('admin/supervisi/store') ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <?= csrf_field() ?>
                                ...
                                <div class="row">
                                    <div class="form-group col-4">
                                        ...
                                        <input id="tgl_supervisi" type="date" class="form-control" name="tgl_supervisi" required>
                                    </div>
                                    <div class="form-group col-4">
                                        <label for="jam_supervisi">Waktu/Jam</label>
                                        <input id="jam_supervisi" type="time" class="form-control" name="jam_supervisi" required>
                                    </div>
                                    <div class="form-group col-4">
                                        <label for="type">Tipe Supervisi</label>
                                        <select class="form-control select2" name="type" id="type" required>
                                            <option value="">Pilih Tipe Supervisi</option>
