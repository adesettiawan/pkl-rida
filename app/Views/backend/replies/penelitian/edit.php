                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Surat Balasan Penelitian</h4>
                            <div class="card-header-action">
                                <a href="<?= base_url('admin/data_balasan_penelitian') ?>" class="btn btn-dark"><i class="fas fa-angle-left"></i>&ensp;Back</a>
                            </div>
                        </div>
                        <?php
                        ...
                        <form action="<?= base_url('admin/data_balasan_penelitian/update/' . $balasan['id']) ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <?= csrf_field() ?>
                                ...
                                <div class="row">
                                    <div class="form-group col-4">
                                        ...
                                        <input id="no_surat" type="text" class="form-control" value="<?= $balasan['no_surat'] ?>" name="no_surat" required>
                                    </div>
                                    <div class="form-group col-8">
                                        <label for="nama_surat">Nama Surat</label>
                                        <input id="nama_surat" type="text" class="form-control" value="<?= $balasan['nama_surat'] ?>" name="nama_surat" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <input class="form-control mb-2" type="file" name="file_replies" value="<?= $balasan['file_replies'] ?>" id="file_replies" accept="application/pdf" onChange="validate2(this.value)" />
