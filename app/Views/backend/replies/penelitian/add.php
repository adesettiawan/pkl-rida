                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-header">
                            <h4>Tambah Surat Balasan Penelitian</h4>
                        ...
                        <form action="<?= base_url('admin/data_balasan_penelitian/store') ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <?= csrf_field() ?>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <input class="form-control mb-2" type="file" name="file_replies" id="file_replies" accept="application/pdf" onChange="validate2(this.value)" />
