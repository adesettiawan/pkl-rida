                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Surat Balasan PKL</h4>
                            <div class="card-header-action">
                                <a href="<?= base_url('admin/data_balasan_pkl') ?>" class="btn btn-dark"><i class="fas fa-angle-left"></i>&ensp;Back</a>
                            </div>
                        </div>
                        <?php
                        ...
                        <form action="<?= base_url('admin/data_balasan_pkl/update/' . $balasan['id']) ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <?= csrf_field() ?>
