                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="<?= base_url('user/laporan_penelitian/add') ?>" class="btn btn-primary"><i class="fas fa-plus"></i>&ensp;Tambah Data</a>
                            </div>
                        </div>
                        <?php
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a href="<?= base_url('user/laporan_penelitian/edit/' . $rpt['id']) ?>" class="dropdown-item has-icon"><i class="far fa-edit"></i> Edit</a>

                                                            <div class="dropdown-divider"></div>
                                                            <a href="<?= base_url('user/laporan_penelitian/delete/' . $rpt['id']) ?>" class="dropdown-item has-icon text-danger"><i class="far fa-trash-alt"></i>
                                                                Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
        ...
        <div class="modal fade" id="staticBackdrop<?= $rpt['id'] ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('user/laporan_penelitian/verifikasiToAdmin/' . $rpt['id']) ?>" method="POST">
