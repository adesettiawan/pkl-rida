                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="<?= base_url('user/data_permohonan_kkn/add') ?>" class="btn btn-primary"><i class="fas fa-plus"></i>&ensp;Tambah Data</a>
                            </div>
                        </div>
                        <?php
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a href="<?= base_url('user/data_permohonan_kkn/edit/' . $permohonan['id']) ?>" class="dropdown-item has-icon"><i class="far fa-edit"></i> Edit</a>

                                                            <div class="dropdown-divider"></div>
                                                            <a href="<?= base_url('user/data_permohonan_kkn/delete/' . $permohonan['id']) ?>" class="dropdown-item has-icon text-danger"><i class="far fa-trash-alt"></i>
                                                                Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
        ...
        <div class="modal fade" id="staticBackdrop<?= $permohonan['id'] ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('user/data_permohonan_kkn/verifikasiToAdmin/' . $permohonan['id']) ?>" method="POST">
        ...
        <div class="modal fade" id="staticBackdrop2<?= $permohonan['id'] ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- <form action="<?= base_url('user/data_permohonan_kkn/verifikasiToAdminByWA/' . $permohonan['id']) ?>" method="POST"> -->
                    <div class="modal-body">
                        <p>Apakah anda yakin ingin mengirimkan permohonan verifikasi ? </p>
                    </div>
                    <div class="modal-footer">
