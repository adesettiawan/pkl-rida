...
class RequestKKN extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('peserta/request/kkn/index', $data);
    }
    ...
    public function add()
    {
        ...
        return view('peserta/request/kkn/add', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('user/data_permohonan_kkn');
    }
    ...
    public function edit($id)
    {
        ...
        return view('peserta/request/kkn/edit', $data);
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to(base_url('user/data_permohonan_kkn'));
    }
}
