...
class ReportPKL extends BaseController
{
    ...
    public function add()
    {
        ...
        return view('peserta/report/pkl/add', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('user/laporan_pkl');
    }
    ...
    public function edit($id)
    {
        ...
        return view('peserta/report/pkl/edit', $data);
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to(base_url('user/laporan_pkl'));
    }
}
