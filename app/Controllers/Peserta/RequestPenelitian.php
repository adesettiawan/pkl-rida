...
class RequestPenelitian extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('peserta/request/penelitian/index', $data);
    }
    ...
    public function add()
    {
        ...
        return view('peserta/request/penelitian/add', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('user/data_permohonan_penelitian');
    }
    ...
    public function edit($id)
    {
        ...
        return view('peserta/request/penelitian/edit', $data);
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to(base_url('user/data_permohonan_penelitian'));
    }
}
