...
class ReportKKN extends BaseController
{
    ...
    public function add()
    {
        ...
        return view('peserta/report/kkn/add', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('user/laporan_kkn');
    }
    ...
    public function edit($id)
    {
        ...
        return view('peserta/report/kkn/edit', $data);
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to(base_url('user/laporan_kkn'));
    }
}
