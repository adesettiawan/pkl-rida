...
class RepliesPKL extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('backend/replies/pkl/index', $data);
    }
    ...
    public function add()
    {
        ...
        return view('backend/replies/pkl/add', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend/replies/pkl/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        $path = '../public/assets/file_replies/pkl/';
        ...
        if ($file_reply->isValid() && !$file_reply->hasMoved()) {
            ...
            $file_reply->move(ROOTPATH . 'public/assets/file_replies/pkl');
        } else {
